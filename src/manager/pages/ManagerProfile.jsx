          ...
          <form onSubmit={handleUpdate} className='space-y-4'>
            <div>
              ...
              <input type='text' value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))}
                className='w-full bg-gray-50 rounded-lg border border-gray-200 py-2.5 px-4 text-sm outline-none focus:ring-2 focus:ring-bluelogo/30' id="mgr-prof-name" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type='text' value={form.phoneNumber} onChange={e => setForm(f => ({ ...f, phoneNumber: e.target.value }))}
                className='w-full bg-gray-50 rounded-lg border border-gray-200 py-2.5 px-4 text-sm outline-none focus:ring-2 focus:ring-bluelogo/30' id="mgr-prof-phone" />
            </div>
            <div>
            ...
            <button type='submit' className='bg-bluelogo text-white py-2.5 px-6 rounded-xl font-semibold text-sm transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]' id="mgr-prof-save">
              Save Changes
            </button>
          </form>
        </div>
          ...
          <form onSubmit={handlePwChange} className='space-y-4'>
            <div>
              ...
              <input type='password' value={pwForm.currentPassword} onChange={e => setPwForm(f => ({ ...f, currentPassword: e.target.value }))}
                className='w-full bg-gray-50 rounded-lg border border-gray-200 py-2.5 px-4 text-sm outline-none focus:ring-2 focus:ring-bluelogo/30' id="mgr-pw-current" />
            </div>
            <div>
              <label className='block text-sm font-semibold text-gray-700 mb-1'>New Password</label>
              <input type='password' value={pwForm.newPassword} onChange={e => setPwForm(f => ({ ...f, newPassword: e.target.value }))}
                className='w-full bg-gray-50 rounded-lg border border-gray-200 py-2.5 px-4 text-sm outline-none focus:ring-2 focus:ring-bluelogo/30' id="mgr-pw-new" />
            </div>
            <div>
              <label className='block text-sm font-semibold text-gray-700 mb-1'>Confirm New Password</label>
              <input type='password' value={pwForm.confirm} onChange={e => setPwForm(f => ({ ...f, confirm: e.target.value }))}
                className='w-full bg-gray-50 rounded-lg border border-gray-200 py-2.5 px-4 text-sm outline-none focus:ring-2 focus:ring-bluelogo/30' id="mgr-pw-confirm" />
            </div>
            <button type='submit' className='bg-bluelogo text-white py-2.5 px-6 rounded-xl font-semibold text-sm transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]' id="mgr-pw-save">
              Change Password
            </button>
          </form>
        </div>

  ...
  return (
    <div className='w-full px-8 pb-8'>
      <div className='flex justify-between pt-4 pb-6 animate-slideDown'>
        ...
        <div>
          <IconTextButton text={"Create Work Order"} icon="akar-icons:clipboard" onClickHandler={() => window.location.href = '/manager/work-orders'} />
        </div>
      </div>
      ...
      <div className='pt-6 animate-fadeIn'>
        <RecentWorkOrders 
          ...
          onViewAll={() => window.location.href = '/manager/work-orders'} 
        />
      </div>
    </div>
  )
